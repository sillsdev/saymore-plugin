 ...
 *
 *   ?src=sample|folder & sel=audio|eaf|oral & view=grid|segmenter
 */
...
/** The eaf selection's restorable views (the recorders live on the oral selection's tabs). */
const EAF_VIEWS: readonly EafView[] = ["grid", "segmenter"];
